...
```ts
import { abi as counterAbi } from "hardhat-soko-example/abis/v1.0.1/src_counter.sol_counter";
```
...
```ts
import deployments from "hardhat-soko-example/deployments-summary.json";
```
